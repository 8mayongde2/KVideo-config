...
| 配置源名称 | 标识符 (source) | 对应文件名 | 包含成人内容 | 适用场景 |
| :--- | :--- | :--- | :---: | :--- |
| **精简版 (Lite)** | `jin18` | `lite.json` | ❌ 否 | 家庭使用、轻量级、过滤敏感内容 |
| **精简成人版 (Adult)** | `jingjian` | `adult.json` | ✅ 是 | 个人使用、内容更全 |
| **完整原始版 (Full)** | `full` | `KVideo-config.json` | ✅ 是 | 完整功能、最大兼容性 |
